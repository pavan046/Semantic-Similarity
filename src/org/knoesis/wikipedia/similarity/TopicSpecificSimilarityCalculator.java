...
public class TopicSpecificSimilarityCalculator {
	...
	public static void main(String[] args) {
		try {
			Writer write = new FileWriter(new File("melvins.ranking"));//("us_elections_links.ranking"));
			//United_States_presidential_election,_2012
			TopicSpecificSimilarityCalculator wikiCalc = new TopicSpecificSimilarityCalculator("Melvins");//("United_States_presidential_election,_2012");
